package com.github.prgrms.orders.model.dto;
...
public class OrderDto {
    ...
    public static OrderDto of(Order source) {
    ...
    @Builder
    public OrderDto(Long seq, Long userSeq, Long productId, ReviewDto review, String requestMessage, String rejectMessage, OrderStatus state, LocalDateTime completedAt, LocalDateTime rejectedAt, LocalDateTime createAt) {
        this.seq = seq;
