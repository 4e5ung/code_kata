...
//      offsetString = Long.toString(DEFAULT_OFFSET);
//    }
//
//    long offset = Long.parseLong(offsetString);
//    if( offset < DEFAULT_OFFSET || offset > Long.MAX_VALUE ){
//      offset = DEFAULT_OFFSET;
//    }
//
//    if( sizeString == null ){
//      sizeString = Long.toString(DEFAULT_SIZE);
//    }
//
...
//    }
    ...
    long offset = (offsetString != null) ? Long.parseLong(offsetString) : DEFAULT_OFFSET;
    int size = (sizeString != null) ? Integer.parseInt(sizeString) : DEFAULT_SIZE;
