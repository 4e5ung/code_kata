...
public class GameRoleTest {
    ...
    static Stream<Arguments> getResult(){
        return Stream.of(
                Arguments.of(List.of(1,2,3), List.of(1,2,3), List.of(3, 0)),
                Arguments.of(List.of(1,4,5), List.of(1,2,3), List.of(1, 0)),
                Arguments.of(List.of(1,6,4), List.of(2,1,3), List.of(0, 1)));
    }
}
