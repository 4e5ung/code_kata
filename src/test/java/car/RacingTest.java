...
public class RacingTest {
    ...
    void createRacingGame() throws IllegalAccessException {
        ...
        InGameCars inGameCars = createInGameCars(cars);


        // 게임 인스턴스 생성
        assertThatCode(() -> {RacingGame.createGame(inGameCars);}).doesNotThrowAnyException();
    }
    ...
    void createRacingGameInputEmptyError(List<Car> cars) {
        ...
        assertThatThrownBy(() -> {RacingGame.createGame(createInGameCars(cars));})
